      ...
      <div className='max-w-7xl mx-auto px-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-5 mt-16'>
          ...
          <div className='col-span-1 bg-white p-4 border border-[#F48643] shadow-lg'>
            ...
            {/* Category Filter */}
            <div className='mb-6'>
              <h5 className='font-medium text-[#404040] text-[20px] border-b mb-2 mb-3'>Categories</h5>
              {categories.map((cat) => (
                <div key={cat.id}>
          ...
          {/* Product Grid */}
          <div className='col-span-1 md:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
            {filtered.length === 0 ? (
              ...
              filtered.map((product) => (
                <div key={product.slug} onClick={() => handleProductClick(product.slug)} className='cursor-pointer'>
                  ...
                  <div className='border-1 bg-[#fff] p-3 border-[#e3e3e3] hover:border-[#F48643] duration-300'>
                    <img
                  ...
                  <h4 className='text-[20px] font-medium capitalize'>
                    {product.name}
                  </h4>
                  <div className='flex  mt-2 items-center justify-between'>
                    <div className='flex items-center gap-2'>
                      <div> 
                      <p className='border-[#E2E2E2] text-[18px]'>
                      ₹{product.price}
                    </p>
                    </div>
                    <div>
                      <p className='font-regular border-[#E2E2E2] text-[#F48643] text-[18px]'><del>₹399.00</del></p>
                    </div>
                    </div>
