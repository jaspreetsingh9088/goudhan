...
const VisitOur = () => {
  return (
    ...
    <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 gap-8 items-center mt-16'>
        <div className='text-center bg-[#fff] p-8'>
            <img src={phoneone} alt='' className='block m-auto mb-3'/>
            <h3 className='font-medium text-[20px]'>Phone :</h3>
            <p>+0123 456 789</p>
        </div>
        <div className='text-center bg-[#fff] p-8'>
            <img src={emailtwo} alt='' className='block m-auto mb-3'/>
            <h3 className='font-medium text-[20px]'>Email :</h3>
            <p>support@goudhan.com</p>
        </div>
        <div className='text-center bg-[#fff] p-8'>
            <img src={watch} alt='' className='block m-auto mb-3'/>
