...
const MyDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'profile':
        return <p className="text-gray-700">Update your profile information here.</p>;
      case 'addresses':
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-md bg-[#fff] shadow-lg">
                ...
                <p className="text-gray-600">{userData?.name}</p> {/* Display name */}
              </div>
              <div className="p-4 rounded-md bg-[#fff] shadow-lg">
                <h3 className="font-bold text-[#4D953E] mb-2">Email</h3>
                <p className="text-gray-600">{userData?.email}</p> {/* Display email */}
              </div>
              <div className="p-4 rounded-md bg-[#fff] shadow-lg">
                <h3 className="font-bold text-[#4D953E] mb-2">Phone</h3>
                <p className="text-gray-600">{userData?.phone_number}</p> {/* Display phone number */}
              </div>
              <div className="p-4 rounded-md bg-[#fff] shadow-lg">
                <h3 className="font-bold text-[#4D953E] mb-2">Address</h3>
                <p className="text-gray-600">{userData?.address}</p> {/* Display address */}
              </div>
            </div>
          </>
        );
          ...
          <aside className="bg-[#ed753b] rounded-lg shadow-lg p-5 sticky top-8 self-start h-fit">
            <div className="flex items-center border-b-1 pb-5 border-[#fff] mb-6">
              ...
              <div>
                ...
                <h2 className="text-white text-lg font-semibold">{userData?.name}</h2> {/* Display name */}
              </div>
            </div>
