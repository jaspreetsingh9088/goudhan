...
useEffect(() => {
  if (activeTab === "My Products") {
    ...
    fetch("https://mitdevelop.com/goudhan/admin/api/my-products", {
      headers: {
...
const handleSubmit = async (e) => {
  ...
  formData.append("images", form.images);
    ...
    if (response.ok) {
      ...
      // Switch to Seller Products tab after success
      setActiveTab("Seller Products");
    } else {
